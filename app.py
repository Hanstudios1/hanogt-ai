...
def enhance_with_creativity(text):
    """Normal cevaba yaratıcı bir ekleme yapar."""
    creative_endings = [
        " Belki de bu sadece başlangıçtır.",
        " Kim bilir, gelecekte bunun çok ötesini göreceğiz!",
        " Hayal gücü sınır tanımaz, bunu unutma.",
        " Şimdi bunu bir rüya gibi düşünelim.",
        " Zihninde bu cevabı biraz daha ileri taşıyabilirsin."
    ]
    return text + random.choice(creative_endings)
...
if app_mode == "Sohbet Botu":
    ...
    if user_input:
        ...
        result = enhance_with_creativity(result)
